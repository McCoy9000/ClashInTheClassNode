...
<html lang="es-es">
	...
	<body>
		...
		<!-- Js´s  -->
		<script	src="<spring:url value='/WebContent/resources/js/jqgrid/mainJqgridModule.js?version=1.0'/>"></script>
		<script	src="<spring:url value='/WebContent/resources/js/jqgrid/listJqgridModule.js?version=1.0'/>"></script>
