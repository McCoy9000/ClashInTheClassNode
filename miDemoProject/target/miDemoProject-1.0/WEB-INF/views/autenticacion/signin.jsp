...
<!--<![endif]-->
  <head>
	...
	<link rel="shortcut icon" href="<spring:url value='/WebContent/resources/images/favicon.ico?version=1.0'/> " type="image/x-icon" />
    
    <link rel="stylesheet" href="<spring:url value='/WebContent/3PResources/Patternfly/css/patternfly.css?version=1.0'/>" >
    <link rel="stylesheet" href="<spring:url value='/WebContent/3PResources/Patternfly/css/patternfly-additions.css?version=1.0'/>" >
  ...
  <body>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div id="brand">
            <h1>
             <spring:eval expression="@appPropierties.getProperty('app.name')" /> 
             <c:set var="versionado" value="1.0"></c:set>
             <c:choose>
    ...
    <script src="<spring:url value='/WebContent/resources/js/autenticacion/signinModule.js?version=1.0'/>"></script>
  </body>
