...
<!--<![endif]-->
	...
	<body class="">
	    ...
	    <script src="<spring:url value='/WebContent/3PResources/Bootstrap/js/bootstrap-combobox.js?version=1.0'/>"></script>
	    ...
	    <script src="<spring:url value='/WebContent/3PResources/Bootstrap/js/bootstrap-datepicker.min.js?version=1.0'/>"></script>
	    <script src="<spring:url value='/WebContent/3PResources/Bootstrap/js/bootstrap-datepicker.es.min.js?version=1.0'/>"></script>
	    <script src="<spring:url value='/WebContent/resources/js/_sharedModules/menuPersistenceModule.js?version=1.0'/>"></script>
	    <script src="<spring:url value='/WebContent/resources/js/_sharedModules/utilModule.js?version=1.0'/>"></script>
		...
		<script src="<spring:url value='/WebContent/resources/js/demos/mainFormularioModule.js?version=1.0'/>"></script>
	</body>
</html>