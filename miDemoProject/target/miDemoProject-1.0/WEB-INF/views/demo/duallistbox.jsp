...
<html lang="es-es">
    <head>
        ...
        <link rel="stylesheet" href="<spring:url value='/WebContent/3PResources/duallistbox/css/bootstrap-duallistbox.min.css?version=1.0'/>" >
...
<body>
    ...
    <script src="<spring:url value='/WebContent/3PResources/Bootstrap/js/bootstrap-select.min.js?version=1.0'/>"></script>
    <script src="<spring:url value='/WebContent/3PResources/duallistbox/js/jquery.bootstrap-duallistbox.min.js?version=1.0'/>"></script>

	<script src="<spring:url value='/WebContent/resources/js/demos/mainDuallistboxModule.js?version=1.0'/>"></script>
