...
<html lang="es-es">
    <head>
        ...
        <link rel="stylesheet" href="<spring:url value='/WebContent/3PResources/datetimepicker/css/bootstrap-datetimepicker.min.css?version=1.0'/>" >
...
<body>
    ...
    <script src="<spring:url value='/WebContent/3PResources/Bootstrap/js/bootstrap-select.min.js?version=1.0'/>"></script>
    <script src="<spring:url value='/WebContent/3PResources/moment/moment.js?version=1.0'/>"></script>
    <script src="<spring:url value='/WebContent/3PResources/datetimepicker/js/bootstrap-datetimepicker.min.js?version=1.0'/>"></script>

	<script src="<spring:url value='/WebContent/resources/js/demos/mainDatetimepickerModule.js?version=1.0'/>"></script>
