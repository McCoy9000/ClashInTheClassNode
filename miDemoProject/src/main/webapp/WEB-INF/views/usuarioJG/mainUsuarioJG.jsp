...
<html lang="es-es">
	...
	<body>
		...
		<script	src="<spring:url value='/WebContent/3PResources/jqGrid/js/jquery.jqGrid.min.js?version=${app.version}'/>"></script>
		<script	src="<spring:url value='/WebContent/3PResources/jqGrid/i18n/grid.locale-es.js?version=${app.version}'/>"></script>
		
		<!-- Js´s  -->
		<script	src="<spring:url value='/WebContent/resources/js/usuarioJG/mainUsuarioJGModule.js?version=${app.version}'/>"></script>		
