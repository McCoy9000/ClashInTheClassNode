...
<html lang="es-es">
    <head>
		...
		<link rel="stylesheet" href="<spring:url value='/WebContent/3PResources/jquery-ui-boostrap/css/jquery-ui.css?version=${app.version}'/>" />
...
<body>
    ...
    <script src="<spring:url value='/WebContent/3PResources/jquery-ui-boostrap/js/jquery-ui.min.js?version=${app.version}'/>"></script>

	<script src="<spring:url value='/WebContent/resources/js/demos/mainAutocompleteModule.js?version=${app.version}'/>"></script>
